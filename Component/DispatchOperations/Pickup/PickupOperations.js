...
export default function PickupOperations({pickup,onChange}){
     const appAuth=useSelector((app)=>app.auth);
    console.log(pickup.status,"Assignment Status");
    console.log(pickup)
                       ...
                       case "DELIVERED":
                        ...
                        setData(deliveryItems);
                           ...
                           case  "CONFIRMED":
                            ...
                            if(e.id===4){
                               // deliveryItems[i].accepted=true;
                                confirmItems[i].message="Delivered pickup has been confirmed by customer.";
                                confirmItems[i].accepted=true;
                            delete  confirmItems[i].view;
                            ...
                            setData(confirmItems);
                               ...
                               console.log("Delivered pickup has been confirmed by customer.");
                               break;
             }
         }
